...
public class CustomizedLocator_2605 
{
	public static void main(String[] args) throws Exception
	{
		...
		Thread.sleep(2000);
		w.findElement(By.cssSelector("input.a-input-text.a-span12.a-spacing-micro.auth-required-field.auth-require-phone-validation")).sendKeys("9892715715");//2).TagName.className value
		Thread.sleep(2000);
